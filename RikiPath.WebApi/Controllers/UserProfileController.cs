...
namespace RikiPath.WebApi.Controllers
{
    ...
    public class UserProfileController(IUserProfileService userProfileService) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetProfile(CancellationToken cancellationToken)
        {
            ...
            var result = await userProfileService.GetProfileAsync(cancellationToken);
        ...
        public async Task<IActionResult> UpdateAvatar(IFormFile avatarFile, CancellationToken cancellationToken)
        {
            ...
            var result = await userProfileService.UpdateAvatarAsync(avatarFile, cancellationToken);
            return StatusCode((int)result.StatusCode, result);
        }
        ...
        public async Task<IActionResult> SetJlptGoal([FromBody] SetJlptGoalRequest request, CancellationToken cancellationToken)
        {

            var result = await userProfileService.SetJlptGoalAsync(request, cancellationToken);
            return StatusCode((int)result.StatusCode, result);
        }
        ...
        public async Task<IActionResult> UpdateNotificationSettings([FromBody] UpdateNotificationSettingsRequest request, CancellationToken cancellationToken)
        {
            ...
            var result = await userProfileService.UpdateNotificationSettingsAsync(request, cancellationToken);
            return StatusCode((int)result.StatusCode, result);
        }
    }
}
